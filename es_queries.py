...
adacs_filter = ["_source.meta.time", "_source.meta.spire_id", "_source.response.acs_op_mode_str", "_source.response.angle_to_go_deg",
                "_source.response.eclipse_flag", "_source.response.qbo_hat", "_source.response.omega_b"]
adacs_filter_desc = ["Beacon Time", "Spire ID", "ACS Operation Mode", "Angle-To-Go (commanded QBO vs estimated QBO) In Degrees",
